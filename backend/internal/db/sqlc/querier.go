...
type Querier interface {
	...
	GetPortfolioCashAsOf(ctx context.Context, arg GetPortfolioCashAsOfParams) (string, error)
	...
	GetWalletCategory(ctx context.Context, id int64) (WalletCategory, error)
	GetWalletCategoryBreakdown(ctx context.Context, arg GetWalletCategoryBreakdownParams) ([]GetWalletCategoryBreakdownRow, error)
	...
	ListTransactionsByPortfolioAsc(ctx context.Context, portfolioID int64) ([]ListTransactionsByPortfolioAscRow, error)
